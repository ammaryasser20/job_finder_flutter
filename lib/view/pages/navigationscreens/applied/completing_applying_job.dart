...
class CompletingApplyingJob extends StatelessWidget {
  const CompletingApplyingJob(
      {super.key, required this.applyJobModel, required this.job});
      ...
      body: SafeArea(
        child: Column(
          children: [
                      ...
                      EasyStep(
                        customStep: ClipRRect(
                          child: JobsCubit.get(context).activeStep > 0
                              ...
                              : Text(
                                  '1',
                                  style: JobsCubit.get(context).activeStep == 0
                                      ? Theme.of(context)
                                          .textTheme
                                          .displayLarge!
                                          .copyWith(
                      ...
                      EasyStep(
                        customStep: ClipRRect(
                          child: JobsCubit.get(context).activeStep > 2
                              ...
                              : Text(
                                  '3',
                                  style: JobsCubit.get(context).activeStep == 2
                                      ? Theme.of(context)
                                          .textTheme
                                          .displayLarge!
                                          .copyWith(
              ...
              child: NotificationListener<UserScrollNotification>(
                ...
                child: PageView(
                  ...
                  children: [
                    const Biodata(),
                    TypeOfWork(
                        work: JobsCubit.get(context).applyedjob.data!.jobType!),
            ...
            DefaultBottoom(
                text:
                    JobsCubit.get(context).activeStep == 2 ? 'Submit' : 'Next',
                function: () async {
                  if (applyjobCon.page == 0) {
                    if (fullNameCon.text.isNotEmpty &&
                      ...
                      JobsCubit.get(context).addApplyJob(
                        map: {
                          'jobId': JobsCubit.get(context).applyedjob.data!.id,
                    ...
                    if (JobsCubit.get(context).userCV != null &&
                      ...
                      String cvName =
                          JobsCubit.get(context).userCV!.path.split('/').last;
                      ...
                      FormData formData = FormData.fromMap({
                        ...
                        "jobs_id": JobsCubit.get(context).applyedjob.data!.id,
